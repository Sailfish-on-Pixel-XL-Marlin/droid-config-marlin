# DisplayName: Jolla marlin/@ARCH@ (release) 1
# KickstartType: release
# DeviceModel: marlin
# DeviceVariant: marlin
# Brand: Jolla
...
repo --name=adaptation-common-marlin-@RELEASE@ --baseurl=https://releases.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-common/@ARCH@/
repo --name=adaptation-community-common-marlin-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
patterns-sailfish-device-configuration-marlin
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/marlin
